        ...
        <aside id="sidebar"
            ...
            <div class="p-6 flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    ...
                    <span class="text-xl font-semibold">Student Panel</span>
                </div>
                ...
                <ul class="space-y-2">
                    ...
                    <li>
                        <a href="{{ route('student.dashboard') }}"
                            class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white hover:bg-opacity-10 {{ request()->routeIs('student.dashboard') ? 'active' : '' }}">
                    ...
                    <li>
                        <a href="{{ route('student.payment-receipts') }}"
                            class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white hover:bg-opacity-10 {{ request()->routeIs('student.payment-receipts') ? 'active' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                            </svg>
                            <span class="whitespace-nowrap">Payment Receipt</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('student.certificates.index') }}"
                            class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white hover:bg-opacity-10 {{ request()->routeIs('student.certificates.index') ? 'active' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                            <span class="whitespace-nowrap">My Certificate</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('student.suggestions.index') }}"
                            class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white hover:bg-opacity-10 {{ request()->routeIs('student.suggestions.index') ? 'active' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
                            </svg>
                            <span class="whitespace-nowrap">Suggestions</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ route('student.profile') }}"
                            class="flex items-center space-x-3 p-3 rounded-lg hover:bg-white hover:bg-opacity-10 {{ request()->routeIs('student.profile') ? 'active' : '' }}">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="p-4 border-t border-white border-opacity-20">
                <form action="{{ route('logout') }}" method="POST" class="w-full">
                    @csrf
                    <button type="submit"
                        class="w-full flex items-center justify-center lg:justify-start space-x-3 p-3 rounded-lg bg-red-600 hover:bg-red-700 text-white transition duration-200 font-medium shadow-lg active:scale-95">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="hidden md:block">
                                <p class="text-sm font-semibold text-gray-900">{{ Auth::user()->full_name ?? 'Student' }}</p>

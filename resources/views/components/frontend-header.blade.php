<nav class="bg-white shadow-md fixed w-full z-50 top-0 left-0">
  ...
  <div class="bg-primary text-white text-xs sm:text-sm">
    <div class="max-w-7xl mx-auto flex flex-wrap justify-between items-center px-4 py-3 sm:py-2">
      ...
      <div class="flex flex-wrap space-x-3 sm:space-x-6 items-center">
        ...
        <a href="https://wa.me/{{$company->whatsapp_number}}" target="_blank" class="hover:text-secondary flex items-center transition p-2">
          <i class="fab fa-whatsapp text-sm sm:text-base mr-1 sm:mr-2"></i>
          <span class="hidden sm:inline">{{$company->whatsapp_number}}</span>
        </a>
        <a href="viber://chat?number=%2B9779861404972" class="hover:text-secondary flex items-center transition p-2">
  ...
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center h-16 sm:h-20">
      ...
      <div class="hidden lg:flex items-center space-x-4">
        <div class="relative">
          <input type="text" placeholder="Search..." class="border border-gray-300 rounded-lg pl-4 pr-10 py-2 w-48 focus:ring-2 focus:ring-secondary focus:outline-none text-sm sm:text-base">
          <button class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-secondary">
            <i class="fas fa-search text-sm sm:text-base"></i>
          </button>
        </div>
        <a href="#" class="bg-secondary hover:bg-opacity-90 text-white px-4 py-2 rounded-lg font-medium transition duration-300 shadow-md text-sm sm:text-base">
          Student Portal
        </a>
      </div>
  ...
  <div id="mobile-menu" class="lg:hidden bg-white shadow-md px-4 py-4 space-y-3 overflow-hidden transition-all duration-300 ease-in-out" style="max-height: 0;">
    ...
    <div class="relative">
      <input type="text" placeholder="Search..." class="w-full border border-gray-300 rounded-lg pl-4 pr-10 py-2 focus:ring-2 focus:ring-secondary focus:outline-none text-sm sm:text-base">
      <button class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-secondary">
        <i class="fas fa-search text-sm sm:text-base"></i>
      </button>
    </div>
    <a href="#" class="block bg-secondary text-white px-4 py-2 rounded-lg text-center font-medium text-sm sm:text-base">Student Portal</a>
  </div>
</nav>
...
<style>
  ...
  #mobile-menu.open {
    max-height: 600px; /* Adjusted for more content */
  }
  body {
    padding-top: 100px; /* Matches navbar + top bar height */
  }
  .bg-primary {

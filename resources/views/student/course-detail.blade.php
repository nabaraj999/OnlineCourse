...
<x-student-layout :title="$course->title">
    ...
    {{
        ...
        ($material->type === 'assignment' ? 'bg-blue-100 text-blue-800' :
                                    ...
                                    @elseif($material->external_url)
                                        <a href="{{ $material->external_url }}"
                                           ...
                                           class="inline-flex items-center px-6 py-3 bg-green-600 text-white font-medium rounded-lg hover:bg-green-700 transition shadow-md">
                                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14"/>
                                            </svg>
                                            Open Link
                                        </a>
                                    @endif

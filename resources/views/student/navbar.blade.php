...
<body class="font-raleway bg-gray-50">
    <div class="flex h-screen overflow-hidden">
        <!-- Sidebar -->
        <div id="sidebar" class="sidebar-transition bg-primary text-white w-64 md:w-20 lg:w-64 flex flex-col h-full fixed lg:relative z-50">
            <!-- Logo -->
            ...
            <nav class="flex-1 mt-6 px-4">
                <ul class="space-y-2">
                    ...
                    <li class="mt-10">
                        <a href="#" class="flex items-center space-x-3 p-3 rounded-lg bg-red-500 hover:bg-red-600 text-white">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <header class="bg-white shadow-sm z-10">
                <div class="flex items-center justify-between p-4">
                    ...
                    <div class="relative flex-1 max-w-xl mx-4">
                        ...
                        <input type="text" class="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg bg-gray-50 focus:outline-none focus:ring-2 focus:ring-primary focus:border-transparent" placeholder="Search...">
                    </div>
            ...
            {{-- <main class="flex-1 overflow-y-auto p-6 bg-light">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <p class="text-gray-600">Active courses this semester</p>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <p class="text-gray-600">Upcoming assignments</p>
                    </div>

                    <!-- Card 3 -->
                    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        <div class="flex items-center justify-between mb-4">
                            <h3 class="text-lg font-semibold text-gray-800">Current GPA</h3>
                        ...
                        <p class="text-3xl font-bold text-gray-900 mb-2">3.75</p>
                        <p class="text-gray-600">Out of 4.0 scale</p>
                    </div>

                    <!-- Card 4 -->
                    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300 md:col-span-2 lg:col-span-1">
                        <div class="flex items-center justify-between mb-4">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center text-sm">
                                ...
                                <span>Submitted Web Development assignment</span>
                                <span class="ml-auto text-gray-500">2 hours ago</span>
                            </li>
                            <li class="flex items-center text-sm">
                                <span class="w-2 h-2 bg-secondary rounded-full mr-3"></span>
                                <span>Enrolled in Data Structures course</span>
                                <span class="ml-auto text-gray-500">1 day ago</span>
                            </li>
                            <li class="flex items-center text-sm">
                                <span class="w-2 h-2 bg-green-500 rounded-full mr-3"></span>
                                <span>Received grade for Algorithms exam</span>
                                <span class="ml-auto text-gray-500">3 days ago</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <ul class="space-y-3">
                            <li class="flex items-center text-sm">
                                <span class="text-primary font-medium mr-2">Oct 15:</span>
                                <span>Midterm Exams Begin</span>
                            </li>
                            <li class="flex items-center text-sm">
                                <span class="text-primary font-medium mr-2">Oct 22:</span>
                                <span>Project Submission Deadline</span>
                            </li>
                            <li class="flex items-center text-sm">
                                <span class="text-primary font-medium mr-2">Nov 5:</span>
                    ...
                    <div class="bg-white rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300">
                        ...
                        <div class="grid grid-cols-2 gap-3">
                            <button class="bg-primary text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">View Courses</button>
                            <button class="bg-secondary text-white py-2 px-4 rounded-lg text-sm font-medium hover:bg-yellow-600 transition-colors">Submit Work</button>
                            <button class="bg-gray-200 text-gray-800 py-2 px-4 rounded-lg text-sm font-medium hover:bg-gray-300 transition-colors">Resources</button>
                            <button class="bg-gray-200 text-gray-800 py-2 px-4 rounded-lg text-sm font-medium hover:bg-gray-300 transition-colors">Calendar</button>
                        </div>
                    </div>
                </div>
            </main> --}}

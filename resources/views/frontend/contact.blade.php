...
<body class="bg-lightBg text-gray-800 font-raleway">
    ...
    <main class="container mx-auto px-4 py-12">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-xl max-w-2xl mx-auto">Have questions about our courses? We're here to help and answer any questions you might have.</p>
        </div>
        ...
        <div class="flex flex-col lg:flex-row gap-12">
            ...
            <div class="w-full lg:w-2/5">
                <div class="bg-white rounded-xl shadow-lg p-8 mb-8">
                    ...
                    <div class="mt-10">
                        ...
                        <div class="flex space-x-4">
                            <a href="#" class="bg-primary/10 hover:bg-primary hover:text-white h-12 w-12 rounded-full flex items-center justify-center transition-colors">
                ...
                <div class="bg-white rounded-xl shadow-lg p-8">
                    ...
                    <p class="text-gray-600 mb-6">Find quick answers to common questions in our FAQ section or submit a support ticket.</p>
                    <div class="space-y-4">
            ...
            <button type="submit"
                ...
                <div class="bg-white rounded-xl shadow-lg p-5">
                    ...
                    <div class="map-container">
                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d100940.14245968236!2d-122.43760000000001!3d37.75769999999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x80859a6d00690021%3A0x4a501367f076adff!2sSan%20Francisco%2C%20CA!5e0!3m2!1sen!2sus!4v1685480000000!5m2!1sen!2sus"

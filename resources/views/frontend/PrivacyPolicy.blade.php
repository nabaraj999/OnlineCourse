    ...
    <main class="container mx-auto px-4 py-12">
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-10 hover-effect transition duration-300">
            ...
            <p class="text-gray-700 mb-4 leading-relaxed">
                Welcome to TechLearn's Privacy Policy. This policy describes how we collect, use, and share your personal information when you use our IT course platform.
                We are committed to protecting your privacy and ensuring transparency about our data practices.
            </p>
            <p class="text-gray-700 leading-relaxed">
                By accessing or using our services, you agree to the terms of this Privacy Policy. If you do not agree with our policies and practices,
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-10 hover-effect transition duration-300">
            ...
            <div class="grid md:grid-cols-2 gap-6">
                <div class="bg-lightBg p-4 rounded-lg">
                    ...
                    <p class="text-gray-700 text-sm">Create and manage your user account, process payments, and provide customer support.</p>
                </div>
                <div class="bg-lightBg p-4 rounded-lg">
                    ...
                    <p class="text-gray-700 text-sm">Recommend courses based on your interests and track your learning progress.</p>
                </div>
                <div class="bg-lightBg p-4 rounded-lg">
                    <i class="fas fa-chart-line text-secondary text-xl mb-2"></i>
                    <h3 class="font-semibold text-primary mb-2">Platform Improvement</h3>
                    <p class="text-gray-700 text-sm">Analyze usage patterns to enhance our platform and develop new features.</p>
                </div>
                <div class="bg-lightBg p-4 rounded-lg">
                    <i class="fas fa-envelope text-secondary text-xl mb-2"></i>
                    <h3 class="font-semibold text-primary mb-2">Communication</h3>
                    <p class="text-gray-700 text-sm">Send important updates, course notifications, and promotional offers (with your consent).</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-10 hover-effect transition duration-300">
            ...
            <p class="text-gray-700 mb-4">
                We value your privacy and do not sell your personal information to third parties. We may share your information in the following circumstances:
            </p>
            <ul class="list-disc pl-5 text-gray-700 space-y-2">
                <li><span class="font-semibold">Instructors:</span> Share progress information with course instructors to facilitate learning</li>
                <li><span class="font-semibold">Service Providers:</span> With trusted partners who assist in platform operations</li>
                <li><span class="font-semibold">Legal Requirements:</span> When required by law or to protect our rights and safety</li>
                <li><span class="font-semibold">Business Transfers:</span> In connection with a merger, acquisition, or sale of assets</li>
            </ul>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-10 hover-effect transition duration-300">
            ...
            <div class="flex flex-col md:flex-row items-center md:items-start">
                ...
                <div class="md:w-1/2 bg-primary text-white p-6 rounded-lg">
                    ...
                    <p class="mb-4">We continuously monitor and update our security practices to address emerging threats and vulnerabilities.</p>
                    <div class="flex items-center">
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-10 hover-effect transition duration-300">
            ...
            <p class="text-gray-700 mb-6">
                You have certain rights regarding your personal information. To exercise any of these rights, please contact us using the information provided below.
            </p>
            <div class="grid md:grid-cols-2 gap-6">
                ...
                <div class="border-l-4 border-secondary pl-4 py-2">
                    ...
                    <p class="text-gray-700 text-sm">Request deletion of your personal information, subject to certain exceptions.</p>
                </div>
                <div class="border-l-4 border-secondary pl-4 py-2">
                    <h3 class="font-semibold text-primary">Opt-Out</h3>
                    <p class="text-gray-700 text-sm">Opt-out of marketing communications and certain data processing activities.</p>
                </div>
            </div>
        </section>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-10 hover-effect transition duration-300">
            ...
            <p class="text-gray-700 mb-4">
                Our platform may integrate with or link to third-party services, such as payment processors, video hosting services, and social media platforms.
            </p>
        ...
        <section class="bg-white rounded-lg shadow-md p-6 mb-10 hover-effect transition duration-300">
            ...
            <div class="bg-yellow-50 border-l-4 border-secondary p-4 mt-4">
                <p class="text-gray-700">
                    ...
                    We encourage you to review this policy periodically to stay informed about our information practices.
                </p>
            </div>
        </section>

...
<section id="course-details" class="py-16 bg-primary bg-opacity-5">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        @if (session('error'))
            <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded-lg relative mb-6 mt-8"
                role="alert">
        ...
        @if (session('success'))
            <div class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-lg relative mb-6 mt-8"
                role="alert">
        ...
        <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200 p-6">
                ...
                <div
                    class="text-gray-600 prose prose-sm max-w-none prose-headings:text-gray-800 prose-headings:font-semibold prose-p:my-3 prose-ul:my-3 prose-li:my-2 space-y-4">
